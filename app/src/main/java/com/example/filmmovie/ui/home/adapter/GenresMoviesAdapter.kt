...
import coil.load
import com.example.filmmovie.databinding.ItemHomeMoviesLastBinding
import com.example.filmmovie.models.home.ResponseMoviesList.Data
import javax.inject.Inject

class GenresMoviesAdapter @Inject constructor() : RecyclerView.Adapter<GenresMoviesAdapter.ViewHolder>(){

    private lateinit var binding: ItemHomeMoviesLastBinding
    private var moviesList = emptyList<Data>()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GenresMoviesAdapter.ViewHolder {
        binding = ItemHomeMoviesLastBinding.inflate(LayoutInflater.from(parent.context),parent,false)
        return ViewHolder()
    }

    override fun onBindViewHolder(holder: GenresMoviesAdapter.ViewHolder, position: Int) {
